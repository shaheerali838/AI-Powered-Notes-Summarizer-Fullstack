...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      {/* Main Sidebar (Fixed, 100% Height, Pure Tailwind Styling) */}
      <aside
        className={`fixed top-16 left-0 z-40 h-[calc(100vh-4rem)] bg-white border-r border-slate-200 flex flex-col flex-shrink-0 transition-all duration-300 ease-in-out ${
          isMobile
      ...
      >
        ...
        {/* ========================================================================= */}
        <div className="p-3 border-b border-slate-100 flex flex-col gap-2.5 flex-shrink-0 bg-slate-50/50">
        ...
        {/* ========================================================================= */}
        {/* 2. MIDDLE SECTION: Scrollable History List with Tailwind Scrollbars        */}
        {/* ========================================================================= */}
        <div className="flex-1 min-h-0 flex flex-col p-2.5 overflow-hidden">
          {(sidebarExpanded || isMobile) && (
            <div className="flex items-center justify-between px-2 py-1.5 mb-1 text-slate-400 flex-shrink-0">
              <span className="text-3xs font-bold uppercase tracking-wider">
                Recent Summaries
              </span>
              <span className="px-1.5 py-0.2 rounded-full text-3xs font-semibold bg-slate-100 text-slate-600">
                ...
                <div className="px-3 py-8 text-center text-slate-400 space-y-2">
                  ...
                  {isGuest && (
                    <button
                      ...
                      className="mt-2 text-2xs text-blue-600 font-semibold hover:underline block mx-auto"
                    >
                      Sign in to sync
                    </button>
                  )}
                ...
                return (
                  <div
                    ...
                    className={`group relative flex items-center justify-between p-2 rounded-xl transition-all cursor-pointer ${
                      isSelected
                        ? "bg-blue-50/90 text-blue-900 border-l-3 border-blue-600 font-semibold shadow-2xs"
                        : "hover:bg-slate-100/70 border-l-3 border-transparent text-slate-700"
                    } ${!sidebarExpanded && !isMobile ? "justify-center px-0" : ""}`}
                    title={title}
                  >
                    <div className="flex items-center gap-2.5 min-w-0 flex-1">
                      ...
                      {(sidebarExpanded || isMobile) && (
                        <div className="min-w-0 flex-1">
                          ...
                          <p className="text-3xs text-slate-400 font-normal">
                    ...
                    {(sidebarExpanded || isMobile) && (
                      <button
                        ...
                        className="opacity-0 group-hover:opacity-100 text-slate-400 hover:text-rose-600 p-1 transition-opacity cursor-pointer rounded-md hover:bg-slate-200/60"
        ...
        {/* ========================================================================= */}
        {/* 3. BOTTOM SECTION: Settings Anchored Flush to Bottom                       */}
        {/* ========================================================================= */}
        <div className="mt-auto p-2.5 border-t border-slate-100 bg-slate-50/50 flex flex-col gap-1 flex-shrink-0">
          <Link
            to="/history"
